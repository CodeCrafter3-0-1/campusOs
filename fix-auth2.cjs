...
fs.writeFileSync(
  "C:/Users/Dell/Desktop/campus Os/2026-04-20-you-are-a-senior-full-stack-2/apps/web/src/lib/auth.ts",
  code, "utf8"
);
console.log("auth.ts updated with college email validation!");
